...
ChatGPTに「プロジェクトの進捗状況などの差分だけもらって、Pythonで更新していくのはどうでしょう？」と聞いたら、「いいですね」と返ってきた。この時点では差分をどうやってもらうのかもよくわかっておらず、なんとなく聞いてみただけ。AIの回答からJSONというので貰えばいいんだなと、うっすら理解しだす。
...
4. **Single Source of Truthの重要性**
   - データの真実は1箇所に
   - 閲覧用の形式は、そこから生成する
   - 各アイテムの採番もAIがやってたら適当になるので、Pythonにさせた方がいいでしょうとのこと
